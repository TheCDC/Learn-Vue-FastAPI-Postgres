...
custom_encoders = {Color: convert_color}
...
class CRUDBase(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    def create(self, db: Session, *, obj_in: CreateSchemaType) -> ModelType:
        obj_in_data = jsonable_encoder(obj_in, custom_encoder=custom_encoders)
    ...
    def update(
        ...
        *,
        ...
        obj_data = jsonable_encoder(db_obj, custom_encoder=custom_encoders)
